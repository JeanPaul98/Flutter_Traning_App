...
class AppColor {
  ...
  static Color secondPageContainerGradien1stColor = const Color(0xFFfbfcff);
  static Color secondPageContainerGradien2ndColor = const Color.fromARGB(160, 95, 127, 233);
